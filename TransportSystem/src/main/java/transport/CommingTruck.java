...
@WebServlet("/commingtruck")
public class CommingTruck extends HttpServlet {
	...
	String branchString=(String)req.getSession().getAttribute("branch");
		...
		String tab1="<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">"
				...
				+ " 100%;\"><tr><th>MODEL</th><th>TRUCK NO.</th><th>RC NO.</th><th>INCSURANCE</th><th> OWNER </th><th>MOBILE NO.</th><th>FROM</th><th>STATUS</th></tr>";
		  String tab2="</table><br>   </body></html>";  
	      res.getWriter().print(tab1); 
	      
	      try { 
				PreparedStatement stet1= con.prepareStatement("select * from truckData where rto='"+branchString+"'"); 
